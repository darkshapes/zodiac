...
# async def draw_matplot_labeled(
#     model_stream=ModelStream(),
#     basic: bool = False,
#     circular: bool = False,
#     graph_viz: bool = False,
#     weighted: bool = False,
#     heated: bool = False,
#     subgraph: bool = False,
#     layered: bool = False,
...
#     graph_copy = IntentProcessor()
#     graph_copy.calc_graph()
#     # graph_copy.set_path("text", "image")
#     graph = graph_copy.intent_graph.to_undirected()
#     paths = nx.all_simple_paths(graph, "text", ["text", "image", "speech"])
#     pos = nx.spring_layout(graph)
#     nx.draw(graph, pos, node_size=0, with_labels=False)
...
#     # elif subgraph:
#     #     pos = nx.kamada_kawai_layout(nx_graph)  # positions for all nodes - seed for reproducibility
#     #     edgewidth = [len(graph_copy.intent_graph.get_edge_data(u, v)) for u, v in graph.edges()]
...
#     #     print(vars(paths))
#     #     path_list = [path for path in paths]
#     #     nx.draw_networkx_edges(nx_graph, pos, alpha=0.3, width=edgewidth, edge_color="m")
#     #     nx.draw_networkx_nodes(nx_graph, pos, node_size=5, node_color="#210070", alpha=0.9)
#     #     label_options = {"ec": "k", "fc": "white", "alpha": 0.7}
#     #     nx.draw_networkx_labels(nx_graph, pos, font_size=14, bbox=label_options)
...
#     #     ]
#     #     print(graph.edges())
#     #     color = [subset_color[v] for v in graph]
#     #     nx.multipartite_layout(graph, subset_key="weight")
...
#     # elif vectored:
#     #     pos = nx.kamada_kawai_layout(graph)  # positions for all nodes - seed for reproducibility
#     #     network_options = {
#     #         "font_size": 8,
#     #         "node_size": 800,
#     #         "node_color": "white",
#     #         "linewidths": 2,
#     #         "width": 2,
#     #     }  # node_size=5, node_color="#210070", alpha=0.9
#     #     node_options = {
#     #         "node_size": 800,
#     #         "node_color": "white",
#     #         "edgecolors": "black",
...
#     #         "width": 2,
#     #     }
#     #     # nx.draw_networkx(nx_graph, pos, **network_options)
...
#     #     pos = nx.spring_layout(graph_copy.intent_graph, iterations=10, seed=227)
#     #     nx.draw(graph_copy.intent_graph, pos, node_size=0, alpha=0.4, edge_color="r", font_size=10, with_labels=False)
#     #     edge_labels = nx.get_edge_attributes(nx_graph, "entry")
#     #     nx.draw_networkx_edge_labels(nx_graph, pos, {data[0]: data[1].model for data in edge_labels.items()}, clip_on=False, hide_ticks=False)
...
# asyncio.run(draw_matplot_labeled(vectored=True))
