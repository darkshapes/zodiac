...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/darkshapes/entity-statement/refs/heads/main/png/zodiac/zodiac_dark_stealth.png">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/darkshapes/entity-statement/blob/main/png/zodiac/zodiac_light_stealth.png">
  <img alt="Futuristic, slanted wireframe block type spelling the word 'ZODIAC' using overlapping and interweaving shapes and triangles for the 'O' and 'A'." src="https://github.com/darkshapes/entity-statement/blob/main/png/zodiac/zodiac_dark_bg.png">
</picture><br><br>
